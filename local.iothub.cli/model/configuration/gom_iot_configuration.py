...
class GOMIotConfigurationModel:
    def __init__(self):
        self._model_id = None
    ...
    def get(self, iot_configuration_xml_file_path):
        ...
        self.model_id = iot_configuration_element_tree.find('./gom/model_id').text
        self.provisioning_host = iot_configuration_element_tree.find('./gom/provisioning_host').text
        self.id_scope = iot_configuration_element_tree.find('./gom/id_scope').text
        self.registration_id = iot_configuration_element_tree.find('./gom/registration_id').text
        self.symmetric_key = iot_configuration_element_tree.find('./gom/symmetric_key').text
        self.host = iot_configuration_element_tree.find('./gom/host').text
        self.port = iot_configuration_element_tree.find('./gom/port').text
        self.socket_timeout = iot_configuration_element_tree.find('./gom/socket_timeout').text
        self.external_host = iot_configuration_element_tree.find('./gom/external_host').text
        self.interactive_port = iot_configuration_element_tree.find('./gom/interactive_port').text
        self.simulation_port = iot_configuration_element_tree.find('./gom/simulation_port').text
        return self