...
class URCobotIotConfigurationModel:
    ...
    def get(self, iot_configuration_xml_file_path):
        ...
        self.external_host = iot_configuration_element_tree.find('./ur_cobot/external_host').text
        self.interactive_port = iot_configuration_element_tree.find('./ur_cobot/interactive_port').text
        self.simulation_port = iot_configuration_element_tree.find('./ur_cobot/simulation_port').text
        return self
