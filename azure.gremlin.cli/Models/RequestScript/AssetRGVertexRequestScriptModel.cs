...
{
    public class AssetRGVertexRequestScriptModel : RequestScriptModel, IRequestScript
    {
        public string Status{ get; set; }
        public string Position{ get; set; }
        public AssetRGVertexRequestScriptModel(string id, string name, string status, string position, string description)
        {
            Label = "asset_rg";
            Id = id;
            Name = name;
